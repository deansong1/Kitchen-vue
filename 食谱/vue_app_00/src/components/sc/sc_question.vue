  ...
  <div class="nav_qus w-100">
    ...
    <div class="why" :class="{'d':!isNone}">
      <div class="why1" v-for="(elem,i) of arr" :key="i">
        ...
        <router-link v-text="elem.question" :to="`/sc_answer/${elem.qid}`" class="sel_ques"></router-link>
        <div v-text="elem.ques" class="sel_miao"></div>
          <p class="mts">
            <img src="../../assets/ans.png" alt=""><a>2回答</a>
          </p> 
      </div>
