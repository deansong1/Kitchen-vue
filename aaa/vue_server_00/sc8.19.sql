...
CREATE TABLE sc_que(
   ...
   question  VARCHAR(64),              #问题
   ques      VARCHAR(150),             #问题描述
   uid INT                             #用户id
);
/**答案表**/
CREATE TABLE sc_ans(
...
INSERT INTO sc_index_top VALUES(6,"mor01.jpg","香河肉饼","营养丰富,早餐最爱");
...
INSERT INTO sc_tuijian_top VALUES(NULL,"In-list0.jpg","咖喱虾","2000","19886");
INSERT INTO sc_tuijian_top VALUES(NULL,"In-list01.jpg","宫保鸡丁","1965","199886");
INSERT INTO sc_tuijian_top VALUES(NULL,"In-list02.jpg","滑蛋虾仁","1876","199886");
INSERT INTO sc_tuijian_top VALUES(NULL,"In-list03.jpg","水煮虾","1723","199886");
INSERT INTO sc_tuijian_top VALUES(NULL,"In-list05.jpg","红烧肉炖土豆","1687","199886");
INSERT INTO sc_collect VALUES(NULL,"zwb01.jpg","红烧肉炖土豆",1);


INSERT INTO sc_que VALUES(NULL,"珍珠奶茶","珍珠奶茶里的木薯淀粉可以用什么替代",1);
INSERT INTO sc_que VALUES(NULL,"玉米淀粉","玉米淀粉可以做珍珠奶茶吗",1);
INSERT INTO sc_que VALUES(NULL,"豆腐脑","做豆腐脑一斤豆子加多少斤水泡，一斤豆子用多少内脂，为什么我做的豆腐脑水多又很老，一点都不嫩",1);

INSERT INTO sc_tuijian_det VALUES(NULL,"香河肉饼","香河肉饼.jpg","材料","

面皮材料： 4杯 All Purpose 面粉， 1杯hot water， l 被温水，3teaspoons Cornoa Oil

馅儿料： 1 个洋葱， 4根青葱， 肉末1/2 磅， 姜末少许，盐，胡椒粉，一小勺糖","做法","1. 在面粉中先兑入1杯hotwater 烫面，再加入另一杯温水， 如果有面包机设到dough挡，让它揉去~中间空挡准备肉馅。 没有面包机的同志们就只好上手了， 揉啊揉， 揉到胳臂发酸，面团光滑，然后用润湿的布（kitchen paper 打湿）盖着让面团醒15-20分钟，趁面团休息的时候准备馅料。

2. 洋葱切碎（这个过程就准备好纸巾流泪吧~）， 青葱当然也要切细细的， 把所有馅料和在一起，顺一个方向搅匀。

3. 面团醒好后，分成小剂子，洒干面粉擀成一张又薄又大的面饼， 这时候面团的感觉很软但是劲道易擀不易破.

4. 将和好的馅料均匀的抹在面皮上 （注意以面皮的中心为圆点，用刀切一条半径，半径旁边的1/4个园不要抹料）

5. 然后将面饼一层一层叠起来，边上压紧封口，用点儿劲，不要漏汁儿。用做葱油饼的卷法会漏汤汁，不建议采用。 只是这个办法出来的饼是三角形的，形象差点儿，但味道绝对一流。

6. 平底锅，少许油，放饼烙上，可以用手按按，把饼压薄一点。

7. 起锅，开吃");
INSERT INTO sc_tuijian_det VALUES(NULL,"酱香饼","酱香饼.jpg","材料","面料：高筋面粉20斤，干酵母60克，泡打粉65克，糖2两，吉士粉一小匙，水12斤.色拉油400克.
馅料：生猪肥肉末(不要瘦肉)11斤，蒜5两，姜5两，孜然5匙，辣椒油适量，辣根粉适量，豆瓣酱适量(炸熟)，鸡精粉适量.蚝油半瓶(或老抽适量)，盐适量
辣椒油：色拉油(适量)在没开的时候倒放辣椒粉(适量)中搅匀，制作饼表面油：色拉油30斤，大葱5根，大蒜，姜各半斤，麻椒20克，芹菜4两，花椒20克，大料20克，桂皮30克，当油开的时候把这些料倒入炸至无水份捞出既成.","做法","(1).发面：
...
INSERT INTO sc_tuijian_det VALUES(17,"冬瓜排骨汤","冬瓜排骨汤.jpg","材料","排骨500g斩段，冬瓜800g切块，姜4片，小葱一把","做法","1.排骨洗净控干，锅内水烧开，下排骨煮尽血水，捞出。

2.沙锅中放适量水，放入排骨、姜片、葱结和料酒，大火烧开后，小火慢炖２小时。

3.再投入冬瓜继续炖40-60分钟，直到冬瓜软烂为止。关火前10分钟左右可以放一点温水泡过的枸杞，反正也是好东东

4.调入适量盐和鸡精、撒上葱花即可");
INSERT INTO sc_tuijian_det VALUES(20,"玉米排骨汤","玉米排骨汤.jpg","材料","原料：小排骨300克 玉米一根 胡萝卜一根

调料：葱 姜 料酒 盐","做法","（1）小排加料酒焯水，玉米、胡萝卜改刀，葱结姜片备用。

（2）将所有原料下锅煮，烧开后撇沫，再炖60分钟。

（3）最后起锅调味，点少许醋，可以更好的帮助钙质的吸收。出锅即可。");
INSERT INTO sc_tuijian_det VALUES(24,"猪蹄汤","猪蹄汤.jpg","材料","主料：猪蹄，猪排骨，鸡骨架共1500克，白菜适量，海米少许，盐，味精，料酒，姜片，葱花，花椒各少许。","做法","1、将猪蹄、排骨、鸡骨架用温水洗净，放火锅内，加水烧开，撇去浮沫，放入葱花、姜片、花椒、料酒，用急火连续煮2-3小时，直至汤汁呈乳白色、浓香扑鼻时捞出骨头。
2、将浸泡好的海米放入汤锅内，把白菜切成小块，也放入锅内，用旺火翻煮，加盐、味精，搅匀即成。");
INSERT INTO sc_tuijian_det VALUES(34,"胡椒猪肚汤","胡椒猪肚汤.jpg","材料","
猪肚1个，白胡椒粒1大匙，水800㏄，
A.姜50公克，葱2根，八角4粒，
B.盐1/2小匙，米酒1大匙","做法","1.将白胡椒粒用刀面压碎成白胡椒碎备用。
